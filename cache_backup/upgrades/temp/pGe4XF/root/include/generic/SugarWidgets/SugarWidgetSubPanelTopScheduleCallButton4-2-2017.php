...
class SugarWidgetSubPanelTopScheduleCallButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= "<input id='Activities_logcall_button' name='Activities_logcall_button' class='button' type='submit' value='Log Call' data-toggle='modal' data-target='#myModalcustom_popup' />";
