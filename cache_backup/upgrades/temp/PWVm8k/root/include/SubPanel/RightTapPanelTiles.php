        ...
        if($showContainer)
        {
			...
			// if($_GET['action']=="DetailView"){
			       ...
			       echo '<ul class="nav nav-tabs " role="tablist">
                                        <li role="presentation" class="active col-xs-6 col-sm-6 col-md-6 col-lg-6 " style="padding-left:0px !important; padding-right:0px !important;"><a href="#next" aria-controls="home" role="tab" data-toggle="tab" class="righttab">NEXT STEPS</a></li>
