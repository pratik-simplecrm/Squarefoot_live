...
{{if $module=="Accounts" }}
{{if $fields[$colData.field.name].name=="phone_office" || $fields[$colData.field.name].name=="website" || $fields[$colData.field.name].name=="email1"}}
				...
				<div class="{{if $fields[$colData.field.name].name=="email1"}}col-sm-6{{elseif $fields[$colData.field.name].name=="website"}}col-sm-3{{else}}col-sm-2{{/if}}
" scope="col" style="text-align:left;min-height:36px" >
...
{{if $module=="Contacts" }}
{{if $fields[$colData.field.name].name=="phone_work" || $fields[$colData.field.name].name=="email1" || $fields[$colData.field.name].name=="title"}}
				{{if !empty($colData.field.hideIf)}}
				{if !({{$colData.field.hideIf}}) }
				{{/if}}
				{counter name="fieldsUsed"}
				{{if empty($colData.field.hideLabel)}}
				<div class="{{if $fields[$colData.field.name].name=="email1"}}col-sm-6{{/if}}
{{if $fields[$colData.field.name].name!="email1"}}col-sm-2{{/if}}" scope="col" style="text-align:left;min-height:36px" >
				{{if !empty($colData.field.name)}}
				{if !$fields.{{$colData.field.name}}.hidden}
				{{/if}}
				{{if isset($colData.field.customLabel)}}
...
{{if $fields[$colData.field.name].name=="account_name" || $fields[$colData.field.name].name=="sales_stage" || $fields[$colData.field.name].name=="next_step"}}
				{{if !empty($colData.field.hideIf)}}
				{if !({{$colData.field.hideIf}}) }
				{{/if}}
				{counter name="fieldsUsed"}
...
{{if $module=="Leads" }}
{{if $fields[$colData.field.name].name=="phone_mobile" || $fields[$colData.field.name].name=="email1"}}
				{{if !empty($colData.field.hideIf)}}
				{if !({{$colData.field.hideIf}}) }
				{{/if}}
				{counter name="fieldsUsed"}
...
{{if $module=="Cases" }}
{{if $fields[$colData.field.name].name=="priority" || $fields[$colData.field.name].name=="type" || $fields[$colData.field.name].name=="state"}}
				{{if !empty($colData.field.hideIf)}}
				{if !({{$colData.field.hideIf}}) }
				{{/if}}
				{counter name="fieldsUsed"}
...
{{if $module=="Prospects" }}
{{if $fields[$colData.field.name].name=="phone_work" || $fields[$colData.field.name].name=="email1"}}
				{{if !empty($colData.field.hideIf)}}
				{if !({{$colData.field.hideIf}}) }
				{{/if}}
				{counter name="fieldsUsed"}
...
{{if $module=="Prospects" || $module=="Leads" || $module=="Contacts" || $module=="Accounts" || $module=="Opportunities" || $module=="Cases" || $module=="Simpl_Projects" || $module=="Simpl_Project_Milestones" || $module=="simpl_Stories" || $module=="Simpl_Milestone_Invoice"}}

<div class="col-sm-7 custom-left-panel" {{if $module!="Employees"}}style="padding:0px"{{else}}style="border:1px solid #d9dada;padding:0px"{{/if}}>

{{else}}
<div class="col-sm-12 custom-left-panel" {{if $module!="Employees"}}style="padding:0px"{{else}}style="border:1px solid #d9dada;padding:0px"{{/if}}>
{{/if}}
  ...
  <div id='{{$label}}' class="panelContainer" cellspacing='{$gridline}' style="background-color:white;" >
	...
	<div class="col-sm-12">
	    ...
	    {{/if}}
			...
			<div class="{{if $fields[$colData.field.name].vname=="LBL_DESCRIPTION" || $fields[$colData.field.name].vname=="LBL_LINE_ITEMS"}}col-sm-12{{else}}col-sm-6{{/if}}" width='{{$def.templateMeta.widths[$smarty.foreach.colIteration.index].label+$def.templateMeta.widths[$smarty.foreach.colIteration.index].field}}%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
