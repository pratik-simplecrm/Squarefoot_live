...
class SugarView
{
    ...
    public function process()
    {
        ...
        $this->display();
				...
				if($this->type == "detail" ){
				if( $this->module=='Prospects' || $this->module=='Leads' || $this->module=='Contacts' || $this->module=='Accounts' || $this->module=='Opportunities' || $this->module=='Cases')
				{
...
*/
			...
			$theTitle .= "</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td width='100%'><span class='text-uppercase'>$module</span><br><span style='font-size:14px'> $paramString </span></td></tr></table>";
      }
            }
           }
