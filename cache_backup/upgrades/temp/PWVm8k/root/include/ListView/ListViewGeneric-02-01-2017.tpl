...
{if $hideTable == false}
	...
	<table cellpadding='0' cellspacing='0' width='100%' style="border:1px solid #D9DADA" class='list table'>
		 ...
		 {if $pageData.rowAccess[$id].edit}
			...
			{*<a data-toggle="dropdown" class="toggle" title="Action"><i class="fa fa-gear"   style="cursor:pointer"></i></a>
			 ...
			 <ul class="dropdown-menu animated fadeIn">
        		<li><a id="edit-{$rowData.ID}" href="index.php?module={$linkModule}&offset={$offset}&stamp={$pageData.stamp}&return_module={$linkModule}&action={$action}&record={$rowData.ID}"><i class="fa fa-edit"></i>Edit</a></li>
        		...
        		<!-- <input type="checkbox" value="1ac527da-76c7-08e6-ee1b-5526574a0937" name="mass[]" class="checkbox" onclick="sListView.check_item(this, document.MassUpdate)" title="Select this row"> -->
         		...
         		<li><a id="delete_listview_top" onclick="document.getElementById('{$rowData.ID}').checked = true;var r = sListView.send_mass_update('selected','Please select at least 1 record to proceed.', 1); r?'':document.getElementById('{$rowData.ID}').checked = false"><i class="fa fa-trash"></i>Delete</a></li>
				...
				{/php}
         		...
         		{if !$linkModule|in_array:$module}

         		

         		<li><a href="?module=Calls&action=EditView&return_module={$linkModule}&return_action=ListView&parent_name=test&parent_id={$rowData.ID}&parent_type={$linkModule}"><i class="fa fa-phone"></i>Log Call</a></li>

         		<li><a href="?module=Meetings&action=EditView&return_module={$linkModule}&return_action=ListView&parent_name=test&parent_id={$rowData.ID}&parent_type={$linkModule}"><i class="fa fa-users"></i>Schedule Meeting</a></li>
         		<li><a href="?module=Tasks&action=EditView&return_module={$linkModule}&return_action=ListView&parent_name=test&parent_id={$rowData.ID}&parent_type={$linkModule}"><i class="fa fa-tasks"></i>Add To Do</a></li>
         		{/if}
    		</ul>
    		*}
    		</div>
