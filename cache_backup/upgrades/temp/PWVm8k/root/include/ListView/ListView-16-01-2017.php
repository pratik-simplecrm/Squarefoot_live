...
/* ------------ Subpanel activities and history module start-------Roshan Sarode-------*/
						...
						$this->xTemplate->assign('CELL', "<strong  data-toggle='tooltip' data-placement='bottom' title='Click'>".$widget_contents."</strong><br>");
						...
						//$this->xTemplate->assign('CELL', "&nbsp;&nbsp|&nbsp;&nbsp".$res_days_ago);	
						}
						else {
						$this->xTemplate->assign('CELL', $widget_contents);
...
/* ------------ Subpanel activities and history module end-------Roshan Sarode-------*/
        ...
        // the action buttons in a list view. Relevant bugs: #51647 and #51640.
				...
				$ext_class="pull-right round-button";
				}	
				/* ------------ Subpanel activities and history module end-------Roshan Sarode-------*/
        ...
        if(!empty($button_contents))
        {
            ...
            // bug#51275: smarty widget to help provide the action menu functionality as it is currently sprinkled throughout the app with html
                ...
                $action_button = smarty_function_sugar_action_menu(array(
                    ...
                    'class' => 'clickMenu subpanel records fancymenu '.$ext_class,
