...
class SugarWidgetSubPanelTopCreateTaskButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= "<input id='Activities_createtask_button' name='Activities_createtask_button' class='button' type='submit' value='Create Task' data-toggle='modal' data-target='#myModalcustom_popup'
		/>";
