...
class SugarWidgetSubPanelTopScheduleMeetingButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= "<input id='Activities_schedulemeeting_button' name='Activities_schedulemeeting_button' class='button' type='submit' value='Schedule Meeting' data-toggle='modal' data-target='#myModalcustom_popup'/>";
