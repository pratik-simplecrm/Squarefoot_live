...
class SugarWidgetSubPanelTopCreateNoteButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		//module_button is used to override the value of module name
					...
					$button .= "<input id='History_createnoteorattachment_button' name='History_createnoteorattachment_button' class='button' type='submit' value='Create Note or Attachment' data-toggle='modal' data-target='#myModalcustom_popup_history'
		/>";
