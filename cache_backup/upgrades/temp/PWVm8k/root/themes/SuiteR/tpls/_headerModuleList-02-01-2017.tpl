...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header" style="width:55px">
        ...
        <div class="hidden-xs hidden-sm" id="bs-example-navbar-collapse-1">
			...
			<a href='index.php?module=Users&action=DetailView&record={$CURRENT_USER_ID}'><i class="fa fa-user-circle fa-2x" aria-hidden="true"></i>
