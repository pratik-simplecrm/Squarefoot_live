...
<ul class="dashboardTabList">
    ...
    {if !$lock_homepage}
        <li class="addButton ">
            <a style='cursor: pointer;border:1px solid #2382D5' class="btn-sm " onclick="return SUGAR.mySugar.showDashletsDialog();">{$lblAddDashlets}</a>
        </li>

        <li class="addButton ">
            <a style='cursor: pointer;border:1px solid #2382D5' class="btn-sm" onclick="addDashboardForm({$tabNum});">
                <span>{$lblAddTab}</span>
            </a>
        </li>
    {/if}
