<?php /* Smarty version 2.6.11, created on 2017-08-17 11:26:15
...
<?php else: ?>
	...
	<?php ob_start();  echo $this->_tpl_vars['fields']['sales_stage']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['sales_stage']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
