...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Leads/DetailView.tpl', 128, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/DetailView.tpl', 214, false),array('modifier', 'escape', 'cache/modules/Leads/DetailView.tpl', 608, false),array('modifier', 'url2html', 'cache/modules/Leads/DetailView.tpl', 608, false),array('modifier', 'nl2br', 'cache/modules/Leads/DetailView.tpl', 608, false),array('modifier', 'substr', 'cache/modules/Leads/DetailView.tpl', 758, false),array('modifier', 'to_url', 'cache/modules/Leads/DetailView.tpl', 760, false),array('modifier', 'strip_tags', 'cache/modules/Leads/DetailView.tpl', 796, false),array('function', 'sugar_include', 'cache/modules/Leads/DetailView.tpl', 161, false),array('function', 'counter', 'cache/modules/Leads/DetailView.tpl', 171, false),array('function', 'sugar_translate', 'cache/modules/Leads/DetailView.tpl', 213, false),array('function', 'sugar_phone', 'cache/modules/Leads/DetailView.tpl', 222, false),array('function', 'sugar_getimage', 'cache/modules/Leads/DetailView.tpl', 415, false),array('function', 'sugar_ajax_url', 'cache/modules/Leads/DetailView.tpl', 688, false),array('function', 'sugar_getjspath', 'cache/modules/Leads/DetailView.tpl', 1040, false),)), $this); ?>
...
<div class="inlineEdit" type="varchar" field="first_name"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['designation_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DESIGNATION','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="varchar" field="designation_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['designation_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['designation_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['designation_c']['value']; ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['flooring_tpye_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FLOORING_TPYE_C','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="enum" field="flooring_tpye_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['flooring_tpye_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['flooring_tpye_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['flooring_tpye_c']['options'][$this->_tpl_vars['fields']['flooring_tpye_c']['value']]; ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTURAL_FIRM_LEADS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="relate" field="arch_architectural_firm_leads_1_name"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida']['value'] )):  ob_start(); ?>index.php?module=Arch_Architectural_Firm&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="arch_architectural_firm_leads_1arch_architectural_firm_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida']['value'] )): ?></a><?php endif;  endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
</div>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTS_CONTACTS_LEADS_1_FROM_ARCH_ARCHITECTS_CONTACTS_TITLE','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="relate" field="arch_architects_contacts_leads_1_name"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida']['value'] )):  ob_start(); ?>index.php?module=Arch_Architects_Contacts&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="arch_architects_contacts_leads_1arch_architects_contacts_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida']['value'] )): ?></a><?php endif;  endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
</div>
</div>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['prospect_source_description_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PROSPECT_SOURCE_DESCRIPTION','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="text" field="prospect_source_description_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['prospect_source_description_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['prospect_source_description_c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['prospect_source_description_c']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
