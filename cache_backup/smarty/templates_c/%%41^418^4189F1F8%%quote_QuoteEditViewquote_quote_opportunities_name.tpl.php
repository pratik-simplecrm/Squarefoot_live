<?php /* Smarty version 2.6.11, created on 2017-09-20 14:50:36
         compiled from cache/include/InlineEditing/quote_QuoteEditViewquote_quote_opportunities_name.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/include/InlineEditing/quote_QuoteEditViewquote_quote_opportunities_name.tpl', 7, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/quote_QuoteEditViewquote_quote_opportunities_name.tpl', 18, false),)), $this); ?>

<input type="text" name="<?php echo $this->_tpl_vars['fields']['quote_quote_opportunities_name']['name']; ?>
" class="sqsEnabled" tabindex="1" id="<?php echo $this->_tpl_vars['fields']['quote_quote_opportunities_name']['name']; ?>
...
"<?php echo ',"name":'; ?>
"<?php echo $this->_tpl_vars['fields']['quote_quote_opportunities_name']['name']; ?>
"<?php echo '}}'; ?>
, 
	"single", 
	true
