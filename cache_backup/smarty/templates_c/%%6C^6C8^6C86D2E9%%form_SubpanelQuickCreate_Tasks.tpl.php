<?php /* Smarty version 2.6.11, created on 2017-12-15 18:06:08
...
"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Tasks');; form.action.value='Save'; if(check_form('form_SubpanelQuickCreate_Tasks'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Tasks_subpanel_save_button" id="Tasks_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"><?php endif; ?> <input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" class="subpanel_cancel_button_custom" class="button" onclick="var _form = document.getElementById('EditView');SUGAR.subpanelUtils.cancelCreate($(this).attr('id'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Tasks_subpanel_cancel_button" id="Tasks_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
