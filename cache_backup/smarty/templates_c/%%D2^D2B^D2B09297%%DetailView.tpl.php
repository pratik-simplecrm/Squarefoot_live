<?php /* Smarty version 2.6.11, created on 2017-12-15 11:02:31
         compiled from cache/modules/Arch_Architects_Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 124, false),array('function', 'sugar_translate', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 133, false),array('function', 'counter', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 140, false),array('function', 'sugar_getimage', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 165, false),array('function', 'sugar_phone', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 211, false),array('function', 'sugar_ajax_url', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 407, false),array('function', 'sugar_getjspath', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 796, false),array('modifier', 'strip_semicolon', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 151, false),array('modifier', 'escape', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 504, false),array('modifier', 'url2html', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 504, false),array('modifier', 'nl2br', 'cache/modules/Arch_Architects_Contacts/DetailView.tpl', 504, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Arch_Architects_Contacts'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Arch_Architects_Contacts'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Arch_Architects_Contacts'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Arch_Architects_Contacts'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<li><a id="tab0" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_INFORMATION','module' => 'Arch_Architects_Contacts'), $this);?>
</em></a></li>

<li><a id="tab1" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_INFORMATION','module' => 'Arch_Architects_Contacts'), $this);?>
</em></a></li>
</ul>
...
<div class="inlineEdit" type="phone" field="phone_home"   class="phone" style="font-size:14px;word-wrap: break-word;">
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTURAL_FIRM_ARCH_ARCHITECTS_CONTACTS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="relate" field="arch_architectural_firm_arch_architects_contacts_1_name"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['arch_archieaacal_firm_ida']['value'] )):  ob_start(); ?>index.php?module=Arch_Architectural_Firm&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['arch_archieaacal_firm_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="arch_archieaacal_firm_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['arch_archieaacal_firm_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['arch_archieaacal_firm_ida']['value'] )): ?></a><?php endif;  endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
</div>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['business_potential']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BUSINESS_POTENTIAL','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="enum" field="business_potential"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['business_potential']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['business_potential']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['business_potential']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['business_potential']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['business_potential']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['business_potential']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['business_potential']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['business_potential']['options'][$this->_tpl_vars['fields']['business_potential']['value']]; ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['last_contacted_date_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_CONTACTED_DATE','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
...
<div class="col-sm-12" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['archi_type']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCHI_TYPE','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="enum" field="archi_type"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['archi_type']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['archi_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['archi_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['archi_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['archi_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['archi_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['archi_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['archi_type']['options'][$this->_tpl_vars['fields']['archi_type']['value']]; ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['educational_institutional']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EDUCATIONAL_INSTITUTIONAL','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="bool" field="educational_institutional"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['educational_institutional']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['educational_institutional']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['educational_institutional']['name']; ?>
" value="$fields.educational_institutional.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
