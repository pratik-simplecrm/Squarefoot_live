<?php /* Smarty version 2.6.11, created on 2017-11-24 14:59:04
         compiled from cache/include/InlineEditing/OpportunitiesEditViewarch_architectural_firm_opportunities_1_name.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/include/InlineEditing/OpportunitiesEditViewarch_architectural_firm_opportunities_1_name.tpl', 7, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/OpportunitiesEditViewarch_architectural_firm_opportunities_1_name.tpl', 18, false),)), $this); ?>

<input type="text" name="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_opportunities_1_name']['name']; ?>
" class="sqsEnabled" tabindex="1" id="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_opportunities_1_name']['name']; ?>
...
"<?php echo ',"name":'; ?>
"<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_opportunities_1_name']['name']; ?>
"<?php echo '}}'; ?>
, 
	"single", 
	true
