...
"  class="button" onclick="var _form = (this.form) ? this.form : document.forms[0]; disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Contacts'))SUGAR.subpanelUtils.inlineSave(_form.id, 'Contacts_subpanel_save_button');return false;" type="submit" name="Contacts_subpanel_save_button" id="Contacts_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
" ><?php endif; ?> 
...
"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Contacts'); disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Contacts'))SUGAR.subpanelUtils.inlineSave(_form.id, 'Contacts_subpanel_save_button');return false;" type="submit" name="Contacts_subpanel_save_button" id="Contacts_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'first_name\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'phone_mobile\', \'phone\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'email1\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'primary_address_street\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'primary_address_city\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'primary_address_state\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STATE','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'primary_address_postalcode\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_POSTALCODE','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'primary_address_country\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_COUNTRY','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'account_type_imported\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_TYPE_IMPORTED','module' => 'Contacts','for_js' => true), $this); echo '\' );
