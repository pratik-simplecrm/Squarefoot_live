<?php /* Smarty version 2.6.11, created on 2017-12-15 10:59:20
         compiled from cache/modules/Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 94, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_advanced.tpl', 101, false),array('modifier', 'default', 'cache/modules/Accounts/SearchForm_advanced.tpl', 109, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_modified_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='educational_institution_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDUCATIONAL_INSTITUTION','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['educational_institution_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['educational_institution_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['educational_institution_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['educational_institution_c_advanced']['name']; ?>
"   >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='retail_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RETAIL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['retail_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['retail_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['retail_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['retail_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hotel_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOTEL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['hotel_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['hotel_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['hotel_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['hotel_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contractor_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTRACTOR','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['contractor_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['contractor_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['contractor_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['contractor_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hospital_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOSPITAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['hospital_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['hospital_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['hospital_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['hospital_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='builder_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUILDER','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['builder_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['builder_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['builder_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['builder_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='pharmaceutical_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PHARMACEUTICAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['pharmaceutical_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['pharmaceutical_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['pharmaceutical_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['pharmaceutical_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
