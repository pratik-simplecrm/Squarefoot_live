<?php /* Smarty version 2.6.11, created on 2017-12-16 10:46:02
         compiled from cache/modules/Arch_Architects_Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 38, false),array('modifier', 'default', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 56, false),array('modifier', 'strip_semicolon', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 64, false),array('modifier', 'lookup', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 457, false),array('modifier', 'count', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 537, false),array('function', 'sugar_include', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 44, false),array('function', 'sugar_translate', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 51, false),array('function', 'counter', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 57, false),array('function', 'html_options', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 71, false),array('function', 'sugar_getjspath', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 225, false),array('function', 'sugar_getimagepath', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 407, false),array('function', 'sugar_getscript', 'cache/modules/Arch_Architects_Contacts/EditView.tpl', 1162, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=Arch_Architects_Contacts'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_HOME_PHONE','module' => 'Arch_Architects_Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"arch_archieaacal_firm_ida","name":"arch_architectural_firm_arch_architects_contacts_1_name"}}'; ?>
, 
"single", 
true
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'salutation\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SALUTATION','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'first_name\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'last_name\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'full_name\', \'fullname\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'title\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TITLE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'photo\', \'image\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PHOTO','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'department\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTMENT','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'do_not_call\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DO_NOT_CALL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_home\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HOME_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email\', \'email\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_mobile\', \'phone\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_work\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OFFICE_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_other\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHER_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_fax\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FAX_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email1\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email2\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHER_EMAIL_ADDRESS','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'invalid_email\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_INVALID_EMAIL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email_opt_out\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_OPT_OUT','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_street\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_street_2\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET_2','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_street_3\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET_3','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_city\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_state\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STATE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_postalcode\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_POSTALCODE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'primary_address_country\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_COUNTRY','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_street\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STREET','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_street_2\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STREET_2','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_street_3\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STREET_3','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_city\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_CITY','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_state\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STATE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_postalcode\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_POSTALCODE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'alt_address_country\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_COUNTRY','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assistant\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSISTANT','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assistant_phone\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSISTANT_PHONE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email_addresses_non_primary\', \'email\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_NON_PRIMARY','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'archi_type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCHI_TYPE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'business_potential\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BUSINESS_POTENTIAL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'educational_institutional\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EDUCATIONAL_INSTITUTIONAL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'pharmaceutical\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PHARMACEUTICAL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'hotels\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HOTELS','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'sports\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SPORTS','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'residential\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESIDENTIAL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'hospital\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HOSPITAL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'retail\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RETAIL','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'others\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHERS','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'arch_architectural_firm_arch_architects_contacts_1_name\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTURAL_FIRM_ARCH_ARCHITECTS_CONTACTS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'last_contacted_date_c_date\', \'date\', false,\'Last Contacted Date\' );
addToValidate(\'EditView\', \'architectural_firm_name_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ARCHITECTURAL_FIRM_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'full_name_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FULL_NAME','module' => 'Arch_Architects_Contacts','for_js' => true), $this); echo '\' );
