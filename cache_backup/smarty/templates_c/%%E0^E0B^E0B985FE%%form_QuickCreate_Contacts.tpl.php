...
addToValidate(\'form_QuickCreate_Contacts\', \'email1\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_QuickCreate_Contacts\', \'primary_address_street\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_QuickCreate_Contacts\', \'primary_address_city\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_QuickCreate_Contacts\', \'primary_address_state\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STATE','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_QuickCreate_Contacts\', \'primary_address_postalcode\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_POSTALCODE','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_QuickCreate_Contacts\', \'primary_address_country\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_COUNTRY','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_QuickCreate_Contacts\', \'account_type_imported\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_TYPE_IMPORTED','module' => 'Contacts','for_js' => true), $this); echo '\' );
