...
"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Calls');; form.action.value='Save'; if(check_form('form_SubpanelQuickCreate_Calls'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Calls_subpanel_save_button" id="Calls_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"><?php endif; ?> <input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" class="subpanel_cancel_button_custom" class="button" onclick="var _form = document.getElementById('EditView');SUGAR.subpanelUtils.cancelCreate($(this).attr('id'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Calls_subpanel_cancel_button" id="Calls_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<script>var disabledModules={"Bugs":"Bugs","EvMgr_Evs":"EvMgr_Evs","Project":"Project","ProjectTask":"ProjectTask","Prospects":"Prospects"};</script>
...
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'reminders\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER','module' => 'Calls','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'reschedule_history\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESCHEDULE_HISTORY','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Calls\', \'reschedule_count\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESCHEDULE_COUNT','module' => 'Calls','for_js' => true), $this); echo '\' );
