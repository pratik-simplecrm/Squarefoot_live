<?php /* Smarty version 2.6.11, created on 2017-08-19 11:01:21
...
"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Notes');; form.action.value='Save'; if(check_form('form_SubpanelQuickCreate_Notes'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Notes_subpanel_save_button" id="Notes_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"><?php endif; ?> <input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" class="subpanel_cancel_button_custom" class="button" onclick="var _form = document.getElementById('EditView');SUGAR.subpanelUtils.cancelCreate($(this).attr('id'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="Notes_subpanel_cancel_button" id="Notes_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=0rQba58xq5jpAqa5h4s-qA'></script>
