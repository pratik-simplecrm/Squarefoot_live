<?php /* Smarty version 2.6.11, created on 2017-12-14 13:24:47
         compiled from cache/include/InlineEditing/quote_QuoteEditViewquotation_status.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/include/InlineEditing/quote_QuoteEditViewquotation_status.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/quote_QuoteEditViewquotation_status.tpl', 43, false),array('modifier', 'lookup', 'cache/include/InlineEditing/quote_QuoteEditViewquotation_status.tpl', 38, false),array('modifier', 'count', 'cache/include/InlineEditing/quote_QuoteEditViewquotation_status.tpl', 143, false),)), $this); ?>
...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['quotation_status']['value'] ) && $this->_tpl_vars['fields']['quotation_status']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['quotation_status']['options'],'selected' => $this->_tpl_vars['fields']['quotation_status']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['quotation_status']['options'],'selected' => $this->_tpl_vars['fields']['quotation_status']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['quotation_status']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['quotation_status']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['quotation_status']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
