<?php /* Smarty version 2.6.11, created on 2017-10-04 09:43:47
         compiled from cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 34, false),array('function', 'math', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 45, false),array('function', 'html_options', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 120, false),array('function', 'sugar_getimagepath', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 181, false),array('modifier', 'count', 'cache/modules/RLS_Scheduling_Reports/SearchForm_basic.tpl', 152, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%'">
			...
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'RLS_Scheduling_Reports'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%'">
		...
		<label for='subscribe_active_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUBSCRIBE_ACTIVE','module' => 'RLS_Scheduling_Reports'), $this);?>
</label>
    	</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['subscribe_active_basic']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['subscribe_active_basic']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['subscribe_active_basic']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['subscribe_active_basic']['name']; ?>
"   >
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
	...
	<td scope="row" nowrap="nowrap" width='1%'">
		...
		<label for='periodicity_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PERIODICITY','module' => 'RLS_Scheduling_Reports'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'periodicity_basic','name' => 'periodicity_basic[]','options' => $this->_tpl_vars['fields']['periodicity_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['periodicity_basic']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%'">
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'RLS_Scheduling_Reports'), $this);?>
</label>
    	</td>
