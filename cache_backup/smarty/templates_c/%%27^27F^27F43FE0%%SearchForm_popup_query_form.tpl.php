<?php /* Smarty version 2.6.11, created on 2017-12-15 10:56:10
         compiled from cache/modules/quote_Products/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 87, false),array('function', 'html_options', 'cache/modules/quote_Products/SearchForm_popup_query_form.tpl', 117, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'quote_Products'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='quote_product_category_quote_products_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QUOTE_PRODUCT_CATEGORY_QUOTE_PRODUCTS_FROM_QUOTE_PRODUCT_CATEGORY_TITLE','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_productsquote_product_category_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_productsquote_product_category_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"quote_product_category_quote_productsquote_product_category_ida_advanced","name":"quote_product_category_quote_products_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_products_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['quote_product_category_quote_productsquote_product_category_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='type_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'type_c_advanced','name' => 'type_c_advanced[]','options' => $this->_tpl_vars['fields']['type_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['type_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='tax_class_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TAX_CLASS','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'tax_class_c_advanced','name' => 'tax_class_c_advanced[]','options' => $this->_tpl_vars['fields']['tax_class_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['tax_class_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='uom_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_UOM','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'uom_c_advanced','name' => 'uom_c_advanced[]','options' => $this->_tpl_vars['fields']['uom_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['uom_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='vendor_part_number_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_VENDOR_PART_NUMBER','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['vendor_part_number_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['vendor_part_number_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['vendor_part_number_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['vendor_part_number_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['vendor_part_number_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='item_code_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ITEM_CODE','module' => 'quote_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['item_code_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['item_code_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['item_code_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['item_code_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['item_code_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
