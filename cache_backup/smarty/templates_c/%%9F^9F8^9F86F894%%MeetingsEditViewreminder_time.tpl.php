<?php /* Smarty version 2.6.11, created on 2017-11-15 17:59:08
         compiled from cache/include/InlineEditing/MeetingsEditViewreminder_time.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/include/InlineEditing/MeetingsEditViewreminder_time.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/MeetingsEditViewreminder_time.tpl', 43, false),array('modifier', 'lookup', 'cache/include/InlineEditing/MeetingsEditViewreminder_time.tpl', 38, false),array('modifier', 'count', 'cache/include/InlineEditing/MeetingsEditViewreminder_time.tpl', 143, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
	<select name="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
" 
	id="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
" 
	title=''  tabindex="1"       
	>

	<?php if (isset ( $this->_tpl_vars['fields']['reminder_time']['value'] ) && $this->_tpl_vars['fields']['reminder_time']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['reminder_time']['options'],'selected' => $this->_tpl_vars['fields']['reminder_time']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['reminder_time']['options'],'selected' => $this->_tpl_vars['fields']['reminder_time']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['reminder_time']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['reminder_time']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['reminder_time']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>

			<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
" 
		id="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
" 
		title=''  tabindex="1"          
	...
	<input
		id="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input"
		name="<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input"
		size="30"
...
-image"></button><button type="button"
	        id="btn-clear-<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
...
"></button>
	...
	'; ?>
			...
			<?php echo '
		(function (){
			var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['reminder_time']['name'];  echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
');
			...
			//global variable 
			sync_';  echo $this->_tpl_vars['fields']['reminder_time']['name'];  echo ' = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['reminder_time']['name']; ?>
-input<?php echo '\'))
						SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['reminder_time']['name'];  echo '", syncFromHiddenToWidget);
		'; ?>
