<?php /* Smarty version 2.6.11, created on 2017-12-07 19:04:35
         compiled from cache/modules/Leads/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Leads/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Leads/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Leads/SearchForm_advanced.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/Leads/SearchForm_advanced.tpl', 123, false),array('function', 'html_options', 'cache/modules/Leads/SearchForm_advanced.tpl', 431, false),array('modifier', 'default', 'cache/modules/Leads/SearchForm_advanced.tpl', 134, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='flooring_tpye_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FLOORING_TPYE_C','module' => 'Leads'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'flooring_tpye_c_advanced','name' => 'flooring_tpye_c_advanced[]','options' => $this->_tpl_vars['fields']['flooring_tpye_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['flooring_tpye_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='arch_architects_contacts_leads_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTS_CONTACTS_LEADS_1_FROM_ARCH_ARCHITECTS_CONTACTS_TITLE','module' => 'Leads'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"arch_architects_contacts_leads_1arch_architects_contacts_ida_advanced","name":"arch_architects_contacts_leads_1_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['arch_architects_contacts_leads_1arch_architects_contacts_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='arch_architectural_firm_leads_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTURAL_FIRM_LEADS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE','module' => 'Leads'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"arch_architectural_firm_leads_1arch_architectural_firm_ida_advanced","name":"arch_architectural_firm_leads_1_name_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_leads_1arch_architectural_firm_ida_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
