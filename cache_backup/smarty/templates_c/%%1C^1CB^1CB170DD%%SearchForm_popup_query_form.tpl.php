<?php /* Smarty version 2.6.11, created on 2017-12-15 11:52:00
         compiled from cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 45, false),array('function', 'sugar_getimage', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 89, false),array('function', 'html_options', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 356, false),array('modifier', 'default', 'cache/modules/Arch_Architects_Contacts/SearchForm_popup_query_form.tpl', 100, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_entered_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_modified_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='arch_architectural_firm_arch_architects_contacts_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ARCH_ARCHITECTURAL_FIRM_ARCH_ARCHITECTS_CONTACTS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['arch_archieaacal_firm_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['arch_archieaacal_firm_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"arch_archieaacal_firm_ida_advanced","name":"arch_architectural_firm_arch_architects_contacts_1_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['arch_architectural_firm_arch_architects_contacts_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['arch_archieaacal_firm_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='department_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTMENT','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='primary_address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['assigned_user_id_advanced']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['assigned_user_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['assigned_user_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"assigned_user_id_advanced","user_name":"assigned_user_name_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['assigned_user_id_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='archi_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ARCHI_TYPE','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'archi_type_advanced','name' => 'archi_type_advanced[]','options' => $this->_tpl_vars['fields']['archi_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['archi_type_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='educational_institutional_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDUCATIONAL_INSTITUTIONAL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['educational_institutional_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['educational_institutional_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['educational_institutional_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['educational_institutional_advanced']['name']; ?>
"   >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='hospital_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOSPITAL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='hotels_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HOTELS','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='pharmaceutical_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PHARMACEUTICAL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='residential_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RESIDENTIAL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='retail_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RETAIL','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='sports_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SPORTS','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='others_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_OTHERS','module' => 'Arch_Architects_Contacts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
