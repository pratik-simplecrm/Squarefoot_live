...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.last_contacted_date_c.name}_date" value="{$fields[$fields.last_contacted_date_c.name].value}" size="11" maxlength="10" title='' tabindex="1" onblur="combo_{$fields.last_contacted_date_c.name}.update();" onchange="combo_{$fields.last_contacted_date_c.name}.update(); "    >
...
<td nowrap>
<div id="{$fields.last_contacted_date_c.name}_time_section"></div>
</td>
</tr>
</table>
