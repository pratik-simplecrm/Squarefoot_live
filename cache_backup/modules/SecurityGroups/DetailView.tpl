...
{assign var="value" value=25-06-2014 }
...
{assign var="value" value=12-08-2016 }
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.quote_quote_securitygroups_1_name.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_QUOTE_QUOTE_SECURITYGROUPS_1_FROM_QUOTE_QUOTE_TITLE' module='SecurityGroups'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{if !empty($fields.quote_quote_securitygroups_1quote_quote_ida.value)}
{capture assign="detail_url"}index.php?module=quote_Quote&action=DetailView&record={$fields.quote_quote_securitygroups_1quote_quote_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="quote_quote_securitygroups_1quote_quote_ida" class="sugar_field" data-id-value="{$fields.quote_quote_securitygroups_1quote_quote_ida.value}">{$fields.quote_quote_securitygroups_1_name.value}</span>
{if !empty($fields.quote_quote_securitygroups_1quote_quote_ida.value)}</a>{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</div>
</div>
</div>
