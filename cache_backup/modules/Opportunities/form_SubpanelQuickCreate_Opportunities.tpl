...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'arch_architectural_firm_opportunities_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ARCH_ARCHITECTURAL_FIRM_OPPORTUNITIES_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE' module='Opportunities' for_js=true}{literal}' );
