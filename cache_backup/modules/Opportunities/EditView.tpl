...
<ul class="yui-nav">
<li class="selected"><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='DEFAULT' module='Opportunities'}</em></a></li>
<li class="selected"><a id="tab1" href="javascript:void(1)"><em>{sugar_translate label='LBL_EDITVIEW_PANEL1' module='Opportunities'}</em></a></li>
</ul>
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"arch_archi003bal_firm_ida","name":"arch_architectural_firm_opportunities_1_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"arch_archi342contacts_ida","name":"arch_architects_contacts_opportunities_1_name"}}{/literal}, 
"single", 
true
...
addToValidate('EditView', 'next_step', 'varchar', true,'{/literal}{sugar_translate label='LBL_NEXT_STEP' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'flooring_type_c', 'enum', true,'{/literal}{sugar_translate label='LBL_FLOORING_TYPE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'arch_architects_contacts_opportunities_1_name', 'relate', true,'{/literal}{sugar_translate label='LBL_ARCH_ARCHITECTS_CONTACTS_OPPORTUNITIES_1_FROM_ARCH_ARCHITECTS_CONTACTS_TITLE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'closure_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_CLOSURE_DATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'actual_date_closed_c', 'date', false,'{/literal}{sugar_translate label='LBL_ACTUAL_DATE_CLOSED' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'last_contacted_date_c_date', 'date', false,'Last Contacted Date' );
addToValidate('EditView', 'arch_architectural_firm_opportunities_1_name', 'relate', true,'{/literal}{sugar_translate label='LBL_ARCH_ARCHITECTURAL_FIRM_OPPORTUNITIES_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'installation_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INSTALLATION_STATUS' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'feeback_email_sent_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FEEBACK_EMAIL_SENT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'installation_completed_c', 'bool', false,'{/literal}{sugar_translate label='LBL_INSTALLATION_COMPLETED' module='Opportunities' for_js=true}{literal}' );
