...
{html_options id='flooring_type_c_advanced' name='flooring_type_c_advanced[]' options=$fields.flooring_type_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.flooring_type_c_advanced.value}
   	   	</td>
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.actual_date_closed_c_advanced.name}" id="{$fields.actual_date_closed_c_advanced.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.actual_date_closed_c_advanced.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.actual_date_closed_c_advanced.name}",
form : "",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.actual_date_closed_c_advanced.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
