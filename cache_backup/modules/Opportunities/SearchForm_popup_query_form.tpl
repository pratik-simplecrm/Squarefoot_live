...
{html_options id='opportunity_type_advanced' name='opportunity_type_advanced[]' options=$fields.opportunity_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.opportunity_type_advanced.value}
   	   	</td>
