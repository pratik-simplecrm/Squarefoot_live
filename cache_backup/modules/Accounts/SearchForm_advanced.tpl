...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.billing_address_country_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='educational_institution_c_advanced'>{sugar_translate label='LBL_EDUCATIONAL_INSTITUTION' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.educational_institution_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.educational_institution_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.educational_institution_c_advanced.name}" name="{$fields.educational_institution_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='retail_c_advanced'>{sugar_translate label='LBL_RETAIL' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.retail_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.retail_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.retail_c_advanced.name}" name="{$fields.retail_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hotel_c_advanced'>{sugar_translate label='LBL_HOTEL' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.hotel_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.hotel_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.hotel_c_advanced.name}" name="{$fields.hotel_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contractor_c_advanced'>{sugar_translate label='LBL_CONTRACTOR' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.contractor_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.contractor_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.contractor_c_advanced.name}" name="{$fields.contractor_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hospital_c_advanced'>{sugar_translate label='LBL_HOSPITAL' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.hospital_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.hospital_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.hospital_c_advanced.name}" name="{$fields.hospital_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='builder_c_advanced'>{sugar_translate label='LBL_BUILDER' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.builder_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.builder_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.builder_c_advanced.name}" name="{$fields.builder_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='pharmaceutical_c_advanced'>{sugar_translate label='LBL_PHARMACEUTICAL' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.pharmaceutical_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.pharmaceutical_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.pharmaceutical_c_advanced.name}" name="{$fields.pharmaceutical_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
