...
{html_options id='type_c_advanced' name='type_c_advanced[]' options=$fields.type_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.type_c_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='quote_Products'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='quote_Products'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
