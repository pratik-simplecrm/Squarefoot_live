...
addToValidate('form_QuickCreate_Contacts', 'primary_address_street', 'varchar', true,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'primary_address_city', 'varchar', true,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_CITY' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'primary_address_state', 'varchar', true,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_STATE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'primary_address_postalcode', 'varchar', true,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_POSTALCODE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'primary_address_country', 'varchar', true,'{/literal}{sugar_translate label='LBL_PRIMARY_ADDRESS_COUNTRY' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'account_type_imported', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_TYPE_IMPORTED' module='Contacts' for_js=true}{literal}' );
