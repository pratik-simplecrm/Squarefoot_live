...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Arch_Architects_Contacts'}</label>
    	</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='arch_architectural_firm_arch_architects_contacts_1_name_advanced'>{sugar_translate label='LBL_ARCH_ARCHITECTURAL_FIRM_ARCH_ARCHITECTS_CONTACTS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.name}" size="" value="{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.arch_archieaacal_firm_ida_advanced.name}" value="{$fields.arch_archieaacal_firm_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"arch_archieaacal_firm_ida_advanced","name":"arch_architectural_firm_arch_architects_contacts_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.arch_architectural_firm_arch_architects_contacts_1_name_advanced.name}.value = ''; this.form.{$fields.arch_archieaacal_firm_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='department_advanced'>{sugar_translate label='LBL_DEPARTMENT' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.department_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='primary_address_city_advanced'>{sugar_translate label='LBL_PRIMARY_ADDRESS_CITY' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.primary_address_city_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_name_advanced'>{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<button type="button" name="btn_{$fields.assigned_user_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.assigned_user_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"assigned_user_id_advanced","user_name":"assigned_user_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.assigned_user_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.assigned_user_name_advanced.name}.value = ''; this.form.{$fields.assigned_user_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='email_advanced'>{sugar_translate label='LBL_ANY_EMAIL' module='Arch_Architects_Contacts'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='archi_type_advanced'>{sugar_translate label='LBL_ARCHI_TYPE' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='archi_type_advanced' name='archi_type_advanced[]' options=$fields.archi_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.archi_type_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='educational_institutional_advanced'>{sugar_translate label='LBL_EDUCATIONAL_INSTITUTIONAL' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.educational_institutional_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.educational_institutional_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.educational_institutional_advanced.name}" name="{$fields.educational_institutional_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='hospital_advanced'>{sugar_translate label='LBL_HOSPITAL' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.hospital_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.hospital_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.hospital_advanced.name}" name="{$fields.hospital_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='hotels_advanced'>{sugar_translate label='LBL_HOTELS' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.hotels_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.hotels_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.hotels_advanced.name}" name="{$fields.hotels_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='pharmaceutical_advanced'>{sugar_translate label='LBL_PHARMACEUTICAL' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.pharmaceutical_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.pharmaceutical_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.pharmaceutical_advanced.name}" name="{$fields.pharmaceutical_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='residential_advanced'>{sugar_translate label='LBL_RESIDENTIAL' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.residential_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.residential_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.residential_advanced.name}" name="{$fields.residential_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='retail_advanced'>{sugar_translate label='LBL_RETAIL' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.retail_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.retail_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.retail_advanced.name}" name="{$fields.retail_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='sports_advanced'>{sugar_translate label='LBL_SPORTS' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.sports_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.sports_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.sports_advanced.name}" name="{$fields.sports_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='others_advanced'>{sugar_translate label='LBL_OTHERS' module='Arch_Architects_Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{if strval($fields.others_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.others_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.others_advanced.name}" name="{$fields.others_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
