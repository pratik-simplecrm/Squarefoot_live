...
{html_options id='resolution_advanced' name='resolution_advanced[]' options=$fields.resolution_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.resolution_advanced.value}
   	   	</td>
