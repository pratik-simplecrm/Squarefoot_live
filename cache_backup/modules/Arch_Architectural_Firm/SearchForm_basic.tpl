...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%'">
			...
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='Arch_Architectural_Firm'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%'">
		...
		<label for='archi_basic' >{sugar_translate label='LBL_ARCHI' module='Arch_Architectural_Firm'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='archi_basic' name='archi_basic[]' options=$fields.archi_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.archi_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%'">
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Arch_Architectural_Firm'}</label>
    	</td>
