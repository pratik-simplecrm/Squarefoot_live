 ...
 $GLOBALS["dictionary"]["Task"]=array (
  ...
  array (
    ...
    array (
      ...
      'module' => 'EvMgr_Evs',
      'bean_name' => 'EvMgr_Evs',
      'vname' => 'LBL_EVMGR_EVS_ACTIVITIES_TASKS_FROM_EVMGR_EVS_TITLE',
    ),
    ...
    array (
      ...
      'vname' => 'LBL_QUOTE_QUOTE_ACTIVITIES_1_TASKS_FROM_QUOTE_QUOTE_TITLE',
    ),
    'arch_architectural_firm_activities_1_tasks' => 
    array (
      'name' => 'arch_architectural_firm_activities_1_tasks',
      'type' => 'link',
      'relationship' => 'arch_architectural_firm_activities_1_tasks',
      'source' => 'non-db',
      'module' => 'Arch_Architectural_Firm',
      'bean_name' => 'Arch_Architectural_Firm',
      'vname' => 'LBL_ARCH_ARCHITECTURAL_FIRM_ACTIVITIES_1_TASKS_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE',
    ),
    ...
    array (
      ...
      'vname' => 'LBL_ARCH_ARCHITECTS_CONTACTS_ACTIVITIES_1_TASKS_FROM_ARCH_ARCHITECTS_CONTACTS_TITLE',
    ),
  ),
  'relationships' => 
  array (
