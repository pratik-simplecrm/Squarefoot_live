...
<li class="selected"><a id="tab1" href="javascript:void(1)"><em>{sugar_translate label='LBL_PANEL_ADVANCED' module='Leads'}</em></a></li>
</ul>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESIGNATION' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.designation_c.value) <= 0}
{assign var="value" value=$fields.designation_c.default_value }
{else}
{assign var="value" value=$fields.designation_c.value }
{/if}  
<input type='text' name='{$fields.designation_c.name}' 
id='{$fields.designation_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"arch_architectural_firm_leads_1arch_architectural_firm_ida","name":"arch_architectural_firm_leads_1_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"arch_architects_contacts_leads_1arch_architects_contacts_ida","name":"arch_architects_contacts_leads_1_name"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PROSPECT_SOURCE_DESCRIPTION' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.prospect_source_description_c.value)}
{assign var="value" value=$fields.prospect_source_description_c.default_value }
{else}
{assign var="value" value=$fields.prospect_source_description_c.value }
{/if}  
<textarea  id='{$fields.prospect_source_description_c.name}' name='{$fields.prospect_source_description_c.name}'
rows="4" 
cols="60" 
title='' tabindex="0" 
 >{$value}</textarea>
...
addToValidate('EditView', 'status', 'enum', true,'{/literal}{sugar_translate label='LBL_STATUS' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'prospect_source_description_c', 'text', false,'{/literal}{sugar_translate label='LBL_PROSPECT_SOURCE_DESCRIPTION' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'arch_architects_contacts_leads_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ARCH_ARCHITECTS_CONTACTS_LEADS_1_FROM_ARCH_ARCHITECTS_CONTACTS_TITLE' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'designation_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DESIGNATION' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'arch_architectural_firm_leads_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ARCH_ARCHITECTURAL_FIRM_LEADS_1_FROM_ARCH_ARCHITECTURAL_FIRM_TITLE' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'flooring_tpye_c', 'enum', false,'{/literal}{sugar_translate label='LBL_FLOORING_TPYE_C' module='Leads' for_js=true}{literal}' );
