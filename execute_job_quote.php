...
/**
 * Author 		: Vivek Gaidhane
 * Created Date  : 18 JAN 2018
 * Motive 		: To create custom scheduler for Custom Reports to send the mail for Quote
 * Organization  : SimpleCRM.
 */
