                                    ...
                                    {if count($shortcutTopMenu.$name) > 0}
                                        ...
                                        {foreach from=$shortcutTopMenu.$name item=item}
                                            {if $item.URL == "-"}
                                                ...
                                                <!-- {$item|@print_r} -->
                                                {if $item.MODULE_NAME != 'CreateArch_Architects_Contacts' and $item.LABEL != 'Create Architects' and $item.ID != 'CreateArch_Architects_Contacts_link'}
                                                <li><a href="{$item.URL}">{$item.LABEL}</a></li>
                                                {/if}
                                            {/if}
                                            {/foreach}
            ...
            <div id="globalLinks" class="dropdown navbar-nav navbar-right" style="padding:6px">
                ...
                <span id="usermenu" class="dropdown-toggle" aria-expanded="true">
                    {if file_exists($profile_path_tpl)}
                        <a href='#' style="padding-top:9px" class="profile-icon-hd" ><div class="profile_pic" style='background-image:url({php}echo $profile_path_img;{/php})'>
                            </div>
                        </a>
                    {else}
                        <div class="profile_pic" style="margin-top:3px"><a href='#' style="padding-top:9px" data-letters="{$FIRST_LETTER_CURRENT_USER}" class="profile-icon-hd">{*<i class="fa fa-user-circle fa-2x" aria-hidden="true" ></i>{$CURRENT_USER}<span class="caret"></span>*}
                            </a></div>
                        {/if}
                </span>
                ...
                <ul class="dropdown-menu custom-profile-menu" role="menu" aria-labelledby="dropdownMenu1" >
                    <li style="text-align:center;">
                        ...
                        {if file_exists($profile_path_tpl)}
                            <a href='#' style="padding-top:9px;max-width:100% !important;"><div class="profile_pic_big" style='border:1px solid #D9DADA;background-image:url({php}echo $profile_path_img;{/php})'></div></a>
                            {else}
                            <div class="profile_pic_big" ><a href='#' style="padding-top:0px;max-width:100% !important" data-letters-big="{$FIRST_LETTER_CURRENT_USER}">	</a></div>
                        {/if}
                    </li>
