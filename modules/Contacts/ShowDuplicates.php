...
$query = "select c.id, c.first_name, c.last_name, concat(u.first_name,' ',u.last_name) as title from contacts c join users u on c.assigned_user_id = u.id and u.deleted = 0 where c.deleted=0 ";
