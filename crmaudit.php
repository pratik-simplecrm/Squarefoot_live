...
HTML;
		...
		$emails = array('chaitanya@simplecrm.com.sg');
	...
	public function sendEmail($email,$from_date,$to_date){
        ...
        $mail->SMTPAuth = true;                               
        $mail->Username = 'rajesh@simplecrm.com.sg';                 
        $mail->Password = $sugar_config['name'];                           
        $mail->SMTPSecure = 'tls';                            
        $mail->Port = 587;                 
		...
		$mail->addCC('aniket@simplecrm.com.sg');
		$mail->addCC('mangesh@simplecrm.com.sg');
		$mail->addCC('iliyas@simplecrm.com.sg');
