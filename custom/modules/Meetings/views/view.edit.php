...
class MeetingsViewEdit extends ViewEdit {
	...
	<script>
		$(document).ready(function() {
			...
			addToValidate('EditView','assigned_user_name','assigned_user_name',true,'User Name');
			addToValidate('EditView','parent_name','parent_name',true,' Relate to');
			
			$('#parent_name_label').html('Related to: <font color="red">*</font>');
			$('#assigned_user_name_label').html('Assigned to: <font color="red">*</font>');
...
HTML;
	...
	//~ $team =<<<EOD
				//~ <script>
					...
					//~ $('#form_SubpanelQuickCreate_Meetings_tabs #team_name').val(team_name);
					//~ $('#form_SubpanelQuickCreate_Meetings_tabs #team_id').val(team_id);
