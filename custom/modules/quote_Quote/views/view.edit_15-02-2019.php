    ...
    function display() {
		...
		$(document).ready(function() {
			...
			$('#packing_charges_c').change(function(){
				var packing_charges = $('#packing_charges_c').val();
				var freight_charges = $('#freight_charges_c').val();
				var loading_charges = $('#loading_unloading_charges_c').val();
				var other_charges = $('#other_charges_c').val();
